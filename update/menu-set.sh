...
wstls=$(service ws-tls status | grep active | cut -d ' ' $stat)
if [ "$wstls" = "active" ]; then
rewstls="${green}ONLINE${NC}"
else
rewstls="${red}OFFLINE${NC}"
fi
...
slow=$(service client status | grep active | cut -d ' ' $stat)
if [ "$slow" = "active" ]; then
...
echo -e "   [INFO] • Restarting Ws-Tls Services        "
sleep 1
...
echo -e "   [INFO] • Restarting SlowDns            "
echo -e "   [INFO] • All Services Restates Successfully  "
sleep 1
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo ""
...
echo -e "\033[1;93m〔⎆〕 ${grenbo}9.${NC} \033[0;36mMENU TEMA ${NC}"
echo -e "\033[1;36m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m"
echo -e ""
